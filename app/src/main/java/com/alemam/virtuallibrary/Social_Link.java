...
public class Social_Link extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null)
        {
            if(UrlKey.equals("facebook")) {
                 url = "https://www.facebook.com/suvo242/";
                 animationView.setAnimation(R.raw.facebook);
            } else if (UrlKey.equals("instagram")) {
                 url = "https://twitter.com/MdAlEmam2/";
                animationView.setAnimation(R.raw.twitter);
            } else if (UrlKey.equals("github")) {
